...
public:
	p_UpperBlockFace(){};
	p_UpperBlockFace( int x, int y, float z, h_Direction dir );
...
public:
	p_BlockSide(){};
	p_BlockSide( int x, int y, int z, h_Direction dir );
	p_BlockSide( int x, int y, float z0, float z1, h_Direction dir );
